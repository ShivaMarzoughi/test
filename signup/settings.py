...
SECRET_KEY = 'django-insecure-&&=#%mz!u*n5f%q5s)d#aj@p(&!_+nubl0yvb7mnoc5)yv$_m#'
...
AUTH_USER_MODEL = 'signup_otp.CustomUser'  # نام اپلیکیشن و مدل شما

# برای jwt استفاده میکنیم
REST_AUTH = {
    'USE_JWT': True,
...
#  به دلیل محدودیت‌های CORS (Cross-Origin Resource Sharing) 
